...
% font={stretch=1.0} — многострочные подписи через одинарный интервал (п. 4.6.3)
\captionsetup[table]{position=t, singlelinecheck=false, justification=raggedright, labelsep=emdash, name=Таблица, font={stretch=1.0}}
